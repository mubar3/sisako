            ...
            <div class="box-body">
                  <div class="tab-content">
                    <div class="tab-pane active" id="tab_1">
                      <a href="<?php echo base_url('Dashboard/admin/data/user/list'); ?>">All (<?php echo $user_jumlah; ?>)</a> | <a href="<?php echo base_url('Dashboard/admin/data/user/list/bin'); ?>">Trash (<?php echo $jumlah_sampah_user; ?>)</a>
                          <hr>
