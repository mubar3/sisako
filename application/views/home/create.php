...
<script type="text/javascript" src="jquery/jquery.min.js"></script>
      ...
      <div class="row">
        ...
        <section class="col-lg-12">
          ...
          <div class="box box-success">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form id="form" action="<?php echo base_url(). 'PublicController/tambah_aksi'; ?>" method="post" enctype="multipart/form-data">
                <div class="col-lg-6">
  ...
  $(document).ready(function(){
    $("#provinsi").change(function (){
        var url = "PublicController/add_ajax_kab/"+$(this).val();
        $('#kota').load(url);
        return false;
    })

  $("#kota").change(function (){
          var url = "<?php echo site_url('PublicController/add_ajax_kec');?>/"+$(this).val();
          $('#kecamatan').load(url);
          return false;
      })

  $("#kecamatan").change(function (){
          var url = "<?php echo site_url('PublicController/add_ajax_des');?>/"+$(this).val();
          $('#desa').load(url);
          return false;
      })
