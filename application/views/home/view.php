      ...
      <div class="row">
        ...
        <section class="col-lg-12">
          ...
          <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title">Edit Idititas</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <?php foreach ($edit_anggota as $e) { ?>
              <form id="form" action="<?php echo base_url('public/anggota/update'); ?>" method="post" onsubmit="return validasi();" enctype="multipart/form-data">
        ...
        <div class="box box-success">
          ...
          <!-- /.box -->
                ...
                <div class="box-body">
                <div class="form-group">
                  <a href="<?php echo base_url('public/anggota/update'); ?>"><input type="button" value="Kembali" class="btn btn-warning"></a>
                <?php } ?>
