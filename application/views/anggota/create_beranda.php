...
<script type="text/javascript" src="jquery/jquery.min.js"></script>
      ...
      <div class="row">
        ...
        <section class="col-lg-12">
          ...
          <div class="box box-success">
            ...
            <div class="box-body">
              <!-- <h1>yaaaa</h1> -->
              <?php echo form_open_multipart('InputController/tambah_aksi');?>
  ...
  $(document).ready(function(){
    $("#provinsi").change(function (){
        var url = "InputController/add_ajax_kab/"+$(this).val();
        $('#kota').load(url);
        return false;
    })

  $("#kota").change(function (){
          var url = "<?php echo site_url('InputController/add_ajax_kec');?>/"+$(this).val();
          $('#kecamatan').load(url);
          return false;
      })

  $("#kecamatan").change(function (){
          var url = "<?php echo site_url('InputController/add_ajax_des');?>/"+$(this).val();
          $('#desa').load(url);
          return false;
      })
