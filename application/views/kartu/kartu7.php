...
<body style="padding-top: 60px; padding-left: 2px;">
  <div style="  position: absolute; margin-left: 635px;
...
<div style=" padding: 25px; float: left; margin-left: 10px; margin-top:-64px;width: 570px;height: 350px;margin-bottom: 12px;background-size: 570px 350px;background-image: url('<?php echo base_url(); ?>assets/img/kartu/blkhitam.png'); background-repeat: no-repeat; background-origin: content-box;">
</div>
          <?php } ?>
</body>
